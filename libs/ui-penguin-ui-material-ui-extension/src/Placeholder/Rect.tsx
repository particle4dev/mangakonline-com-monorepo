...
export type PlaceholderRectProps = WithStyles<typeof styles> & {
  readonly style?: React.CSSProperties,
  readonly className?: string
}

const Rect = React.forwardRef(function Rect(props: PlaceholderRectProps, ref: React.Ref<HTMLElement>) {
  debug('render');
